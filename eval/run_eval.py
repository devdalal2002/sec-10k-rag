"""
eval/run_eval.py - Full evaluation harness for the SEC 10-K RAG system.
...
from src.retrieve import retrieve, load_rerank_cache, save_rerank_cache, get_chunk
...
RERANK_CACHE    = Path("data/cache/rerank_cache.json")
